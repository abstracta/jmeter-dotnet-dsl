...
const REPO_LINK = "https://github.com/abstracta/jmeter-dotnet-dsl"


export default defineUserConfig({
  lang: 'en-US',
  title: 'jmeter-dotnet-dsl',
  description: 'Simple JMeter performance tests API',
  base: '/jmeter-dotnet-dsl/',
  head: [
    ['link', { rel: 'shortcut icon', href: '/jmeter-dotnet-dsl/favicon.ico'}],
  ...
  theme: defaultTheme({
    ...
    navbar: [
      ...
      {
        text: 'Motivation',
        link: 'https://abstracta.github.io/jmeter-java-dsl/motivation/',
      },
      {
