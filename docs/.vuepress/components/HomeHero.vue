...
<template>
  <header class="hero">
    <div class="hero-logo"><HomeHeroImage style="margin: 0;"/><span> .net</span></div>

    <!-- changed from original template file to remove title and include JMeter link -->
    <p class="description">
    Simple <AutoLink :item="{link : 'https://jmeter.apache.org/', text: 'JMeter'}"/> performance tests .Net API
    </p>
